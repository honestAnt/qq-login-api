...
implements Serializable {
    ...
    public String getContentType() {
        ...
        String contentType = -1 == index ? "application/octet-stream" : ((extensions = extensions.substring(extensions.lastIndexOf(".") + 1).toLowerCase()).length() == 3 ? ("gif".equals(extensions) ? "image/gif" : ("png".equals(extensions) ? "image/png" : ("jpg".equals(extensions) ? "image/jpeg" : "application/octet-stream"))) : (extensions.length() == 4 ? ("jpeg".equals(extensions) ? "image/jpeg" : "application/octet-stream") : "application/octet-stream"));
        return contentType;
    }
